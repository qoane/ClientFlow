...
namespace ClientFlow.Infrastructure.Migrations
{
    ...
    [Migration("20251111055813_RenameSessionsToTblSessions")]
    partial class RenameSessionsToTblSessions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientFlow.Domain.Feedback.KioskFeedback", b =>
                {
                    ...
                    b.ToTable("KioskFeedback", (string)null);
                });
            ...
            modelBuilder.Entity("ClientFlow.Domain.Surveys.ResponseSession", b =>
                {
                    ...
                    b.ToTable("tblSessions", (string)null);
                });
            ...
            modelBuilder.Entity("ClientFlow.Domain.Surveys.SurveyVersion", b =>
                {
                    ...
                    b.ToTable("SurveyVersions", (string)null);
                });
